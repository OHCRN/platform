...
| `consent-ui`  | `FEATURE_CONSENT_PDF_BUTTONS` | Feature flag for showing buttons on the Dashboard page to display or download completed consent PDFs, for dev and QA.                                                                                                                                   | `boolean` | Optional | `false`                                                                                                                                                        |
